...
% 自然科学
    ...
    % 数学
        ...
        \DeclarePairedDelimiterX{\setParens}[2]{\lbrace}{\rbrace}{#1\,\delimsize\vert\,#2}
        ...
        \providecommand{\Re}{}\renewcommand{\Re}[1]{{\operatorname{Re}{\left(#1\right)}}}
        \providecommand{\Im}{}\renewcommand{\Im}[1]{{\operatorname{Im}{\left(#1\right)}}}
        ...
        \newcommand{\Log}[1]{\operatorname{Log}{#1}}
            ...
            % Z変換
            \newcommand{\ZTrans}[1]{\operatorname{\mathcal{Z}}\left(#1\right)}
            \newcommand{\IZTrans}[1]{\operatorname{\mathcal{Z}}^{-1}\left(#1\right)}
        ...
        \providecommand{\Pr}{}\renewcommand{\Pr}[1]{\operatorname{Pr}\left(#1\right)}
