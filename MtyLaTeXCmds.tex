...
% Latex
    ...
    % [Reference different places to the same footnote](https://tex.stackexchange.com/questions/35043/reference-different-places-to-the-same-footnote)
    \makeatletter
    \newcommand\footnoteRef[1]{\protected@xdef\@thefnmark{\ref{#1}}\@footnotemark}
    \makeatother

    % Escapes underscore.
    \DeclareRobustCommand{\robustEscapeUnderscore}[1]{\StrSubstitute{#1}{_}{\_\allowbreak}} % \allowbreak prevents overfull at table cell.
...
% natural science
    % general purpose
    \newcommand*{\ctext}[1]{\raise0.2ex\hbox{\textcircled{\scriptsize{#1}}}} % circled text for annotation
    ...
    % mathematics
        ...
        \newcommand*{\cl}[1]{\operatorname{cl}#1} % closure of a set
        \newcommand*{\img}[1]{\operatorname{im}\parens*{#1}} % image of a function
        \newcommand*{\dom}[1]{\operatorname{dom}\parens*{#1}} % domain of a function
        ...
        \newcommand*{\Log}{\operatorname{Log}}
            ...
            \newcommand*{\SSZTrans}[1]{\underset{\text{s.s.}}{\mathcal{Z}}\parens*{#1}} % single-sided Z-transform
    ...
    % probability theory
        ...
        \newcommand*{\Ev}[2]{\operatorname{E}_{#1}\bracks*{#2}} % expected value
        \newcommand*{\cE}[3]{\Ev{#1}{\left.#2\right|#3}}
    ...
    % computer science
        ...
        \newcommand*{\pleq}{\mathrel{+}=} % Keep "+=" tight; \mathrel{+=} would insert a \thickmuskip between + and =.
